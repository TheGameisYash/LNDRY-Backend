    ...
    <div className="space-y-4">
      ...
      {showFilters && (
        <div className="flex flex-wrap items-center gap-3 p-3 rounded-lg bg-muted/50 border animate-fade-in">
          ...
          {/* Rider / Employee Filter */}
          <Select
            value={riderFilter || "all_employees"}
            onValueChange={(v) => {
              setRiderFilter(v === "all_employees" ? "" : v)
              setPage(1)
            }}
          >
            <SelectTrigger className="h-9 w-[170px]">
      ...
      <Dialog open={bulkAssignOpen} onOpenChange={setBulkAssignOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Assign Employee to {selectedIds.size} Orders</DialogTitle>
          </DialogHeader>
          <div className="space-y-3 py-2">
          ...
          <DialogFooter>
            ...
            >
              {bulkAssignRiders.isPending ? "Assigning..." : "Assign Employee"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
