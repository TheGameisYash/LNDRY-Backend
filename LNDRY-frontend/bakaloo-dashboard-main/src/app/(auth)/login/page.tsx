  ...
  return (
    <Card className="shadow-lg border-0">
      <CardHeader className="text-center pb-2">
        <div className="mx-auto w-14 h-14 rounded-2xl bg-brand-50 flex items-center justify-center mb-4 p-2.5">
          <img src="/lndry-assets/logos/app-icon.svg" className="h-full w-full object-contain" alt="LNDRY" />
        </div>
        <h1 className="text-2xl font-bold text-foreground font-display">LNDRY Operations</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Sign in to the LNDRY admin control center
        </p>
      </CardHeader>
